...
const Footer = () => {
  return (
    ...
    >
      <section className="bg-secondary md:rounded-lg p-7">
        <div className="container">
          ...
          <div className="grid gap-10 md:grid-cols-3">
            <div>
              <span className="mb-3 flex size-12 flex-col items-start justify-center rounded-full bg-accent">
              ...
              <a
                href="mailto:info@trinovateglobal.org"
                className="font-semibold hover:underline"
              >
                info@trinovateglobal.org
              </a>
            </div>
            <div>
              <span className="mb-3 flex size-12 flex-col items-start justify-center rounded-full bg-accent">
